...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 21808,
    DYNAMIC_BASE = 5264688,
    DYNAMICTOP_PTR = 21648;
...
var wasmBinaryFile = 'findSetOfNumbers.wasm';
...
/** @type {function(...*):?} */
var _searchNumbers = Module["_searchNumbers"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["searchNumbers"].apply(null, arguments)
};
